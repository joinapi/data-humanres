...
class JobRequisition extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Common\Enumeration', 'exam_type_enum_id', 'enum_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Common\Enumeration', 'job_posting_type_enum_id', 'enum_id');
    }
