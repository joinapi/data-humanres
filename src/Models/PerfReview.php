...
class PerfReview extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Humanres\Party', 'employee_party_id', 'party_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Humanres\Party', 'manager_party_id', 'party_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Humanres\Payment', 'payment_id', 'payment_id');
    }
}
