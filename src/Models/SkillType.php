...
class SkillType extends Model
{
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Humanres\QuoteItem', 'skill_type_id', 'skill_type_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Humanres\WorkEffortSkillStandard', 'skill_type_id', 'skill_type_id');
    }
}
