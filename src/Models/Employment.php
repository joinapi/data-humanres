...
class Employment extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Humanres\Party', 'party_id_from', 'party_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Humanres\Party', 'party_id_to', 'party_id');
    }
}
