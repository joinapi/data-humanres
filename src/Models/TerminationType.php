 ...
 * @property TerminationType $terminationTypeByParentTypeId
 */
class TerminationType extends Model
{
     ...
     */
    public function terminationTypeByParentTypeId()
    {
        return $this->belongsTo('Joinbiz\Data\Models\Humanres\TerminationType', 'parent_type_id', 'termination_type_id');
    }
}
